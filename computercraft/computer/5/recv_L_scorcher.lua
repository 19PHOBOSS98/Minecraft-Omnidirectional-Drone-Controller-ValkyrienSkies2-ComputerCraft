...
function applyRedStonePower(lin_mv,rot_mv)
	...
	I would have kept it simple and just used front,back,left and right but that made it more confusing for me at the time of writing the first few iterations
	]]--
	...
	BU = lin_x_p+lin_y_p+rot_x_n+rot_y_p+rot_z_p --BOW UP thruster
	BD = lin_x_p+lin_y_n+rot_x_p+rot_y_p+rot_z_n --BOW DOWN thruster
	SB = lin_z_n --STERN BACKWARD thruster
	SU = lin_x_p+lin_y_p+rot_x_p+rot_y_n+rot_z_p --STERN UP thruster
	SD = lin_x_p+lin_y_n+rot_x_n+rot_y_n+rot_z_n --STERN DOWN thruster
	...
	--[[
	--for STARBOARD receiver:
	BF = lin_z_p
	BU = lin_x_n+lin_y_p+rot_x_n+rot_y_n+rot_z_n
	BD = lin_x_n+lin_y_n+rot_x_p+rot_y_n+rot_z_p
	SB = lin_z_n
	SU = lin_x_n+lin_y_p+rot_x_p+rot_y_p+rot_z_n
	SD = lin_x_n+lin_y_n+rot_x_n+rot_y_p+rot_z_p
